            ...
            <div class="auth-box bg-light border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span style="color: #000;font-size: 18px;">AUTOMOBILE BATTERY VERIFICATION RESULT</span>
                    </div>
                    <!-- Form -->
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <a href="index.html"  class="btn btn-success float-left"><i class="ti-home"></i>&nbsp;&nbsp;&nbsp;Back to Home</a>
                                    </div>
                                </div>
                            </div>
